...
```
***Note:** Depending on the rate of heartbeat/scheduled task intervals, your AI agent's experience at a destination **may take several hours**, even days or so, to complete, just like in the real world. Be patient! Of course, you can always ask them how it is going even when they're not finished yet.*
...
<picture>
  ...
  <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/image?repos=HalfABridge/toykind-world&type=date&legend=top-left" />
  <img alt="Star History Chart" src="https://api.star-history.com/image?repos=HalfABridge/toykind-world&type=date&legend=top-left" />
</picture>
